...
object SparkStreaming11_Req1_BlackList_foreachPartition {
    ...
    def main(args: Array[String]): Unit = {
        ...
        ds.foreachRDD(
            rdd => {
                ...
                rdd.foreachPartition((iter: Iterator[((String, String, String), Int)]) => {
                        val conn = JDBCUtil.getConnection
                        // todo 集合的方法  不是rdd  上面的连接可以直接用
                        iter.foreach{
...
//                                    val conn = JDBCUtil.getConnection
                                    ...
                                    else { // todo 当前的user_ad_count表中还没有对应数据 就要新插入数据
                                        val sql4 = """
